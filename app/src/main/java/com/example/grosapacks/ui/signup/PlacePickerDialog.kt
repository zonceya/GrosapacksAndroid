...
import com.example.grosapacks.databinding.BottomSheetCampusListBinding
...
class PlacePickerDialog : BottomSheetDialogFragment() {
 ...
 /*   var placesList:List<PlaceModel> = ArrayList()
  ...
  /*      val productAdapter =
            PlacesAdapter(requireContext(), placesList, object : PlacesAdapter.OnItemClickListener {
