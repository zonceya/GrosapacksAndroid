        ...
        fun bind(shop: ShopConfigurationModel, position: Int, listener: OnItemClickListener) {
            ...
            if(isShopOpen) {
                if (shop.configurationModel.isOrderTaken == 1) {
                    binding.textShopName.setTextColor(ContextCompat.getColor(binding.layoutRoot.context, R.color.black))
                    binding.textShopDesc.setTextColor(ContextCompat.getColor(binding.layoutRoot.context, R.color.tab_indicator_text))
                    binding.textShopRating.setTextColor(ContextCompat.getColor(binding.layoutRoot.context, R.color.tab_indicator_text))
