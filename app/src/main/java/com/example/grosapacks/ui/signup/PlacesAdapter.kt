...
import com.example.grosapacks.databinding.ItemCampusBinding
import com.squareup.picasso.Picasso

class PlacesAdapter(private val context: Context,  private val listener: OnItemClickListener) : RecyclerView.Adapter<PlacesAdapter.PlaceViewHolder>() {
